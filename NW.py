...
seq1 = "ATAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGGT"
seq2 = "ATAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGGT"
# seq1 = "GCTGATTC"
# seq2 = "GATCTGATTA"
n_rows = len("-"+seq1)
n_columns = len("-"+seq2)
...
def traceback_alignment(traceback_array, seq1, seq2, up_arrow="\u2191", \
    ...
    while arrow != "-":
        ...
        if arrow == up_arrow:
            ...
            raise ValueError(
                "Traceback array entry at {row},{col}: {arrow} is not recognized as an up arrow ({up_arrow}),left_arrow ({left_arrow}), up_left_arrow ({up_left_arrow}), or a stop ({stop}).")
